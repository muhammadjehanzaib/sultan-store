  ...
  const fetchSalesData = async () => {
    ...
    try {
      ...
      orders.forEach((order: any) => {
        ...
        if (orderDate >= startDate && orderDate <= now && dateBuckets[dateKey]) {
    ...
    <div className="bg-white dark:bg-gray-800 shadow rounded-xl border border-gray-200 dark:border-gray-700 col-span-full">
      ...
      <div className="p-6">
        ...
        <div className="overflow-x-auto">
          <div
            className="h-64 flex items-end space-x-2 px-2"
            style={{ width: `${salesData.length * 32}px`, minWidth: '100%' }}
          >
            {salesData.map((data, index) => {
              const height = maxSales > 0 ? (data.sales / maxSales) * 100 : 0;
              return (
                <div key={index} className="w-6 flex flex-col items-center group">
                  <div
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 transform -rotate-45 origin-center whitespace-nowrap">
